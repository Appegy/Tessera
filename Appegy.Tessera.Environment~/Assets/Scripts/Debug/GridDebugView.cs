...
public class GridDebugView : MonoBehaviour
{
    ...
    [SerializeField] [Range(0f, 1f)] private float _classicTabNeck = 0f;
    ...
    private ITessellation CreateGrid()
    {
        switch (_kind)
        {
            ...
            {
                var parameters = new ClassicPuzzleParameters(_classicRoundness, _classicTabRadius, _classicTabOffset, _classicTabDeform, _classicTabNeck);
